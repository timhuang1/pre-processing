...
def rm_empty_preds(args):
    ...
    with open(os.path.join(args.data_dir, in_file), encoding="utf8") as f_in:
    ...
    with open(os.path.join(args.data_dir, out_filename), "w", encoding="utf8") as f_out:
